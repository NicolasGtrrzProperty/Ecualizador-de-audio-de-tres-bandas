...
Los circuitos electrónicos se generan con esquemas de **Qucs-S**, se simulan con **Ngspice**, se dibujan con **[Python](https://www.python.org/downloads/)** y se modelan con **Manim**.
